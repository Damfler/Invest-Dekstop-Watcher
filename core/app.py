...
from ui.icons import (make_icon_normal, make_icon_warn, make_icon_crit)
from core.data_store import DataStore
from ui.menu import MenuBuilder
from utils.notifications import NotificationManager
from ui.window import DashboardWindow
...
class TBankTrayApp:
    ...
    def _do_refresh(self, force_bonds: bool = False):
        ...
        log.info("Портфель обновлён: %s", self._store.last_update)
    ...
    def _do_update_icon_and_tooltip(self):
        ...
        if s["error"]:
            ...
            from utils.formatting import fmt_total, fmt_money, fmt_date
            from utils.analytics import coupon_sum_horizon
